...
const messages = {
    ...
    '2024-01-02': 'Voltando de madrugada da praia para trabalhar, mas a felicidade de ter passado este fim de ano ao seu lado era enorme',
    ...
    '2024-01-20': 'A vida é mais doce com você nela. Sou tão feliz por te chamar de minha.',
    '2024-01-21': 'Nossa primeira festa de aniversário juntos. Que venham muitas mais!',
    ...
    '2024-02-14': 'Neste Valentines day, celebro o presente mais precioso: você!',
    ...
    '2024-03-01': 'O início de março me fez lembrar o quanto a nossa história é linda.',
    ...
    '2024-03-09': 'Show do Armandinho, vc cuidando de mim quase desmaiado kkkkk. Obrigado por tudo!',
    '2024-03-10': 'Houve dias em que bastou pensar em você para me sentir completo.',
    ...
    '2024-03-19': 'Recordar nossos momentos juntos é como reviver os dias mais lindos da minha vida.',
    ...
    '2024-03-22': 'As lembranças do nosso amor fazem meu coração bater mais forte.',
    ...
    '2024-03-25': 'Eu nunca esquecerei a forma como você mudou minha vida.',
    '2024-03-26': 'Seus abraços me fazem sentir que o mundo é um lugar melhor.',
    '2024-03-27': 'As nossas conversas sempre me mostraram o quão especiais são nossos momentos.',
    ...
    '2024-04-01': 'No dia da mentira, a maior verdade é que te amo mais do que tudo!',
    '2024-04-02': 'Lembrar da sua voz doce me fez perceber o quanto sou sortudo por te ter.',
    '2024-04-03': 'Seu amor foi a luz que guiou meus dias escuros e me deu forças.',
    ...
    '2024-04-08': 'Mesmo na distância, seu amor foi como abraço que me envolve.',
    ...
    '2024-04-20': 'Casamento da Juli, nossa primeira festa com a minha família. Você estava linda!',
    ...
    '2024-04-27': 'Relembrar nossos passeios me traz memórias tão doces quanto o seu sorriso.',
    ...
    '2024-06-04': 'Amar você é como tomar sorvete num dia quente.',
    ...
    '2024-06-08': 'Nunca pensei que alguém pudesse roubar meu coração... e cuidar dele melhor que eu mesmo!',
    '2024-06-09': 'Mesmo nos dias mais difíceis, lembrar de você faz tudo parecer mais leve.',
    '2024-06-10': 'Se amar você fosse uma viagem, eu vieveria chapado.',
    '2024-06-11': 'Você é minha calma em meio à correria do mundo.',
    ...
    '2024-06-16': 'Se o amor fosse um jogo, você seria meu combo perfeito!',
    ...
    '2024-06-28': 'Dia do casamento do seu irmão. E o nosso sai quando?',
    ...
    '2024-07-27': 'Nosso primeiro e último passeio com a Athena. Quando teremos outro?',
    '2024-07-28': 'Você é a melhor surpresa que o universo já me deu.',
    '2024-07-29': 'Relembrar nosso amor é minha terapia favorita.',
    '2024-07-30': 'Julho termina, mas o que sinto por você continua e só cresce.',
    '2024-07-31': 'Você é o melhor presente da vida.',
    '2024-08-01': 'Meu primeiro dia de estágio, você me ajudando a superar o nervosismo, eu andando vários km e te comprando flores.',
    ...
    '2024-08-10': 'Amar você me fez perceber que a felicidade é feita de momentos simples.',
    '2024-08-11': 'A tão aguardada entrega das alianças. E o seu anel vai me dar quando?',
    ...
    '2024-08-15': 'Você é a prova de que o amor verdadeiro não tem momento certo.',
    ...
    '2024-08-23': 'Você é como aquela brisa fresca em um dia quente.',
    ...
    '2024-09-07': 'Meu grito de independência é: só quero ser dependente do seu amor.',
    ...
    '2024-09-12': 'Relembrar suas palavras doces é como saborear meu chocolate preferido.',
    '2024-09-13': 'Você é a sexta-feira 13 ao contrário na minha vida, só me traz sorte.',
    ...
    '2024-09-16': 'Seus abraços são como a primavera: confortáveis, lindos e acolhedores.',
    '2024-09-17': 'Relembrar cada momento ao seu lado é como ouvir minha playlist favorita.',
    '2024-09-18': 'Setembro me lembra você: cheio de cores e sempre lindo.',
    '2024-09-19': 'Você é o “bom dia” que traz paz a minha vida.',
    ...
    '2024-09-22': 'O mundo pode mudar, mas meu amor por você é eterno.',
    ...
    '2024-09-26': 'Seu amor é como o cheiro da chuva e grama molhada.',
    ...
    '2024-09-29': 'Você faz até os dias comuns se tornarem extraordinários.',
    ...
    '2024-10-05': 'Você é o motivo pelo qual os dias nublados ainda têm brilho.',
    ...
    '2024-10-09': 'Outubro pode trazer mudanças, mas meu amor por você não muda nunca, só cresce.',
    '2024-10-10': 'Seu sorriso é como o céu: vasto, lindo e irresistível.',
    ...
    '2024-10-13': 'Você é a certeza de que o amor pode ser tão belo quanto as cores do céu.',
    '2024-10-14': 'O melhor da vida é simples: estar com você.',
    '2024-10-15': 'Você é a calmaria em meio aos ventos fortes. Sempre meu refúgio.',
    '2024-10-16': 'Nosso amor é bonito, inesperado e cheio de vida.',
    '2024-10-17': 'Com você, todo dia é como o melhor domingo: aconchegante e feliz.',
    '2024-10-18': 'O meu amor por você aumenta a cada dia que passa. Eu posso não dizer vezes suficientes mas nunca se esqueça: você é a pessoa mais importante da minha vida!',
    '2024-10-19': 'Meu coração encontrou em você o lar que sempre procurou.',
    '2024-10-20': 'Tenho tanta sorte por ter você! Do teu lado, a realidade parece um sonho!',
    '2024-10-21': 'Você me acalma quando estou precisando de paz e enche a minha alma de energia quando eu preciso de forças! Te amo, você é a melhor do mundo!',
    '2024-10-22': 'Com você, até as folhas que caem parecem dançar de alegria.',
    '2024-10-23': 'Seus abraços são o cobertor perfeito para as noites frias.',
    '2024-10-24': 'Você é a certeza de que cada detalhe da vida ao seu lado vale a pena.',
    '2024-10-25': 'Que o nosso amor só cresça e floresça eternamente em um jardim de felicidades. Obrigado por estar sempre ao meu lado, meu amor.',
    '2024-10-26': 'Se o amor tivesse um som, seria a melodia que sinto ao te ver sorrir.',
    '2024-10-27': 'Pensei em como você torna minha vida leve, como a brisa de outubro.',
    '2024-10-28': 'Cada dia ao seu lado é um dia que eu me apaixono ainda mais pelos seus olhos. Eu te amo, meu amor.',
    '2024-10-29': 'Você faz as nuvens cinzentas desaparecerem e ilumina o céu com o sol do seu amor. Eu te amo mais do que tudo!',
    '2024-10-30': 'Outubro está terminando, mas meu amor por você é infinito.',
    '2024-10-31': 'Halloween, e o monstro que mais me assuta é a ideia de te perder (depois vem você de TPM).',
    '2024-11-01': 'Enquanto eu estiver ao seu lado, o meu mundo será perfeito.',
    '2024-11-02': 'Você tem o poder de transformar qualquer dia nublado de novembro em um dia inesquecível.',
    '2024-11-03': 'Com você, até as folhas caídas de novembro parecem mais bonitas.',
    '2024-11-04': 'Meu coração é seu! Nele mora a certeza de que com você encontrei meu destino e a minha grande sorte. ',
    '2024-11-05': 'Você faz de cada dia um capítulo de felicidade na nossa história.',
    '2024-11-06': 'Mesmo com as mudanças de estação, meu amor por você nunca se apaga.',
    '2024-11-07': 'Meu plano é viver eternamente apaixonado por você! Até agora estou cumprindo perfeitamente.',
    ...
    '2024-11-10': 'Toda hora, todo dia, em todo amanhecer, eu não só penso em você, eu vivo por você.',
    '2024-11-11': 'A alegria dos seus olhos são o sorriso do meu coração',
    '2024-11-12': 'Meu coração encontra seu lugar em voc.',
    '2024-11-13': 'Você trouxe leveza, alegria e brilho aos meus dias. É o porto seguro para onde eu sempre retorno.',
    '2024-11-14': 'Seus olhos são o resumo de toda a inspiração que preciso.',
    '2024-11-15': 'Quando estou com você, parece que nada nem ninguém existe, só nós dois.',
    '2024-11-16': 'Cada gesto seu me faz acreditar mais na beleza do mundo e do nosso amor.',
    '2024-11-17': 'Você faz meu coração bater mais forte.',
    '2024-11-18': 'Nosso amor tem a suavidade e a beleza de novembro: perfeito em cada detalhe.',
    '2024-11-19': 'Penso em você quase toda hora. Só não penso toda hora porque quando estou com você não penso em mais nada.',
    '2024-11-20': 'Com você, cada dia é uma celebração. Obrigado por ser a melhor parte da minha vida.',
    '2024-11-21': 'Penso em você noite e dia. Você é minha estrela guia nesse mundo de loucura.',
    '2024-11-22': 'A cada olhar, a cada sorriso, meu amor por você cresce mais.',
    '2024-11-23': 'O simples fato de estar com você torna qualquer dia especial.',
    '2024-11-24': 'Eu respiro você, eu vivo por você, sou louco por você!',
    ...
    '2024-11-27': 'Em cada canto, eu encontro mais motivos para amar você.',
    '2024-11-28': 'Meu coração pertence a você.',
    '2024-11-29': 'Você é uma joia que brilha com esse seu jeitinho encantador!',
    ...
    '2024-12-02': 'O amor por você só cresce mais a cada dia.',
    '2024-12-03': 'Em cada amanhecer, sinto-me grato por ter você ao meu lado.',
    '2024-12-04': 'O mais bonito de dezembro é saber que em cada dia, o meu amor por você só aumenta.',
    '2024-12-05': 'Nosso segundo Natal juntos está chegando, e meu coração já está transbordando de amor por você.',
    '2024-12-06': 'A cada passo que damos juntos, a nossa história de amor se torna mais especial.',
    '2024-12-07': 'Quando relembro nossos lindos momentos, teu sorriso acalma meu coração e toda mágoa e dor se desfazem.',
    '2024-12-08': 'Cada momento ao seu lado é um presente.',
    '2024-12-09': 'Eu não imaginava que o último mês do ano poderia ser tão perfeito ao seu lado.',
    '2024-12-10': 'Amar você é a melhor parte da minha vida.',
    '2024-12-11': 'Você fez deste ano algo inesquecível. Dezembro será a cereja no topo do nosso bolo.',
    '2024-12-12': 'Você ilumina meus dias.',
    '2024-12-13': 'Meu coração já bate mais forte só de pensar no nosso primeiro ano (de muitos) juntos.',
    '2024-12-14': 'O melhor de dezembro não são as festas, mas sim a certeza de ter você ao meu lado',
    '2024-12-15': 'Faltam apenas dois dias para completarmos um ano juntos. Parece que foi ontem que começamos nossa história.',
